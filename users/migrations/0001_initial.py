# Generated by Django 4.2.4 on 2023-08-14 20:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('about_me', models.TextField(max_length=4000, verbose_name='Обо мне')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='properties', to=settings.AUTH_USER_MODEL, verbose_name='Владелец недвижимости')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_service', models.TextField(max_length=200, verbose_name='Описание услуги')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, verbose_name='Название помещния')),
                ('area', models.FloatField(verbose_name='Площадь помещения')),
                ('price', models.FloatField(verbose_name='Стоимость помещения')),
                ('property', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rooms', to='users.property', verbose_name='Номер комнаты')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='feedback_properties', to='users.property', verbose_name='Название недвижимости')),
                ('user_client', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='feedback_properties', to=settings.AUTH_USER_MODEL, verbose_name='Клиент')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='user',
            name='service',
            field=models.ManyToManyField(related_name='users', to='users.service', verbose_name='Услуги'),
        ),
        migrations.AddField(
            model_name='user',
