...
class PropertyAdmin(admin.ModelAdmin):
    list_display = ('user', 'name', 'adress', 'worktime', 'area', 'price')
    search_fields = ('user', 'name', 'adress', 'worktime', 'area', 'price')
    list_filter = ('worktime', 'price', 'area', 'user')


@admin.register(Room)
class RoomAdmin(admin.ModelAdmin):
    list_display = ('property', 'name', 'area', 'price')
...
class FBpropertyAdmin(admin.ModelAdmin):
    ...
    search_fields = ('property', 'raiting', 'user_client')
    list_filter = (
        'property',
        'user_client',
    )
